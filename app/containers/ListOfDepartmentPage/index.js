...
export class ListOfDepartmentPage extends React.Component {
  ...
  render() {
    const { classes, listOfDepartmentPage } = this.props;
    ...
    return (
      <div>
        ...
        >
          ...
          <DialogActions>
            <Button color="primary" variant="contained" autoFocus onClick={() => this.handleAddDepartment()}>
              Lưu thông tin
            </Button>
        ...
        >
          ...
          <DialogActions>
            <Button color="primary" onClick={() => this.handleDeleteDepartment()}>
              Đồng ý
            </Button>
  ...
  handleAddDepartment = () => {
    ...
    if (name.length < 5 || code.length < 5 || type === '') {
      if (name.length < 5) {
