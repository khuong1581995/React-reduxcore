...
import { Typography, TextField, Paper, Button, Grid, FormControlLabel, Checkbox, MenuItem, FormHelperText, FormControl } from '@material-ui/core';
import { Menu, Edit, Settings } from '@material-ui/icons';
            ...
            this.state.typeOfProperty === 10 ? (
              <Grid item md={12} container direction="column">
                ...
                {/* eslint-disable */}
                  ...
                  {/* eslint-enable */}
                <Button variant="contained" color="primary" onClick={this.addRow} style={{ width: '20%', marginTop: 20 }}>
                  Thêm tùy chọn
                </Button>
              </Grid>
            ) : (
