  ...
  return (
    <div>
      <Switch>
        ...
        <PrivateRoute path="/crm/config" layout={MainLayout} component={CrmConfigPage} />

        {/* Setting router */}
        <PrivateRoute exact path="/setting" layout={MainLayout} component={SystemConfigPage} />
        <PrivateRoute path="/setting/user/add" layout={MainLayout} component={AddUserPage} />
        <PrivateRoute path="/setting/user" layout={MainLayout} component={UsersPage} />
