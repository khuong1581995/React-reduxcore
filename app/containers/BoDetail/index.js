...
import { Step, StepLabel, Stepper, Paper, Typography, AppBar, Toolbar, IconButton, Tabs, Tab, Menu, MenuItem, Button, Grid } from '@material-ui/core';
      ...
      <div id="trading-detail" className="transition-item">
        ...
        <Stepper activeStep={1}>
          {this.steps.map((item, index) => (
            <Step key={index} classes={{ completed: { color: 'red' } }}>
              <StepLabel
                style={{ color: 'red' }}
                StepIconProps={{
                  classes: {
        ...
        >
          <TabContainer dir={theme.direction}>
            <TDTGeneral enableSelectField={true} />
          </TabContainer>
          <TabContainer dir={theme.direction}>
            <TDTProduct />
          </TabContainer>
