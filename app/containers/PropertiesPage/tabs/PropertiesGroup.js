      ...
      <div style={{ width: '100%' }}>
        ...
        <GridUI item md={12} container style={{ height: 40, marginBottom: 10 }}>
          ...
          <GridUI item md={8} container justify="flex-end">
            <Button component={Link} to="/setting/properties/propertiesGroup/0" style={{ height: 40 }} variant="contained" color="primary">
              Thêm mới
            </Button>
          </GridUI>
        </GridUI>
        ...
        >
          ...
          <DialogActions>
            <Button color="primary" onClick={() => this.handleDeletes()}>
              Đồng ý
            </Button>
