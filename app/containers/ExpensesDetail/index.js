...
import { expensesDetailRows, expensesDetailColumns } from 'variable';
...
class ExpensesDetail extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      columns: expensesDetailColumns,
      tableColumnExtensions: [{ columnName: 'checkbox', width: 90 }, { columnName: 'setting', width: 70 }],
      rows: expensesDetailRows,
      columnOrder: ['code', 'title', 'unit', 'price', 'quantity', 'vat', 'amount', 'note'],
      selected: [],
      selectAll: false,
      dialogStatus: false,
      activePage: 0,
