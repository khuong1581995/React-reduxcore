      ...
      <div>
        ...
        <div id="print">
          <Card>
            ...
            <CardActions>
              <Button style={{ marginLeft: 20 }} color="primary" variant="contained">
                Lưu
              </Button>
          ...
          <Card style={{ marginTop: 30 }}>
            ...
            <Button style={{ margin: 30 }} color="primary" variant="contained" size="small">
              Bảng mã vạch
            </Button>
            <Button style={{ margin: 30 }} color="primary" variant="contained" size="small">
              Nhãn mã vạch
            </Button>
            <Button style={{ margin: 30 }} color="primary" variant="contained">
              Tạo mã vạch
            </Button>
          </Card>
          <Card style={{ marginTop: 30 }}>
            ...
            <div style={{ display: 'flex' }}>
              <Button onClick={() => PrintElem('print')} style={{ margin: '15px auto' }} color="primary" variant="contained">
                <Print />
                In
              </Button>
            </div>
