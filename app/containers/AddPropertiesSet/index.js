...
import { Paper, TextField, Grid, Button, Typography, FormHelperText, FormControl, FormControlLabel, Checkbox } from '@material-ui/core';
          ...
          <Grid item md={12} container direction="column">
            ...
            <Grid item md={12} container spacing={24}>
              <Grid item md={6}>
                ...
                >
                  <Menu style={{ fontSize: '20px', marginBottom: '5px' }} /> Thông tin đơn hàng
                </Typography>
              </Grid>
              <Grid item md={6}>
                <Typography
